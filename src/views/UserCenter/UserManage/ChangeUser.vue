<template>
  <div class="myinfo-page">
    <UserCenterHeader title="修改用户信息" :showOption="false" :canSearch="false"></UserCenterHeader>
    <el-form ref="form" :model="form" class="user-form"  label-width="110px">
      ...
      <el-form-item class="btn">
        <el-button @click="change" size="mini" type="primary" class="save-btn">修改</el-button>
      </el-form-item>
    </el-form>
  </div>
</template>
...
import { getUserInfoApi, changeUserInfoApi } from "@/api/MyInfo.js"
export default {
  name: "changeUser",
  ...
  methods: {
    async getMyInfo(){
        this.userInfo = await getUserInfoApi(this.$route.query.id)
