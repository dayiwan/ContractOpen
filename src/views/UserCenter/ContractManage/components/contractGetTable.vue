<template>
    <div class="table">
        <el-table :data="ResourceItem">
            ...
            <el-table-column prop="blockDataName" show-overflow-tooltip label="数据集名称" align="center">
            </el-table-column>
            <el-table-column prop="dataCount" show-overflow-tooltip label="数据量" align="center">
            </el-table-column>
            <el-table-column prop="description" show-overflow-tooltip label="数据集描述" align="center">
            </el-table-column>
