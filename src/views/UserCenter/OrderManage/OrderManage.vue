...
import { passOrderApi, refuseOrderApi } from "@/api/OrderManage.js"
...
export default {
    ...
    methods:{
        ...
        formatter(row, column,cellValue, index){
            if (index === 0) {
                return row.platformCheck;
            }else{
                return null;
            }

        },
        formatterSuperviseCheck(row, column,cellValue, index){
            if (index === 0) {
                return row.superviseCheck;
            }else{
                return null;
            }
